...
const imageLightOptions = [
    { text: 'WevrLabs', value: 'https://wevrlabs.sd/wp-content/uploads/sites/8/logo-web-solutions-2020.svg' },
...
const App = (_, state, setState) => {
    ...
    return H('div', { className: 'split' }, H('div', { className: 'pull-left' }, H('div', H(Field, {
        ...
        })), H('div', { className: 'field-flex' }, H(Button, {
            label: `Remove Image ${i + 2}`,
            onclick: (e) => {
                e.preventDefault();
                const filter = (arr) => [...arr].filter((_, n) => n !== i + 1);
